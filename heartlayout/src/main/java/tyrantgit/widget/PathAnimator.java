...
public class PathAnimator extends AbstractPathAnimator {
    ...
    @Override
    public void start(final View child, final ViewGroup parent, final int position) {
        parent.addView(child, new ViewGroup.LayoutParams(mConfig.heartWidth, mConfig.heartHeight));
        FloatAnimation anim = new FloatAnimation(createPath(mCounter, parent, 2),
                randomRotation(), parent, child);
    ...
    static class  myAnimation extends ValueAnimator{
